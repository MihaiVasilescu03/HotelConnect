...
public class AddUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        numeReg = findViewById(R.id.addsignupNume);
        prenumeReg = findViewById(R.id.addsignupPrenume);
        emailReg = findViewById(R.id.addsignupEmail);
        parolaReg = findViewById(R.id.addsignupPassword);
        btnSignUp = findViewById(R.id.addUserButton);
